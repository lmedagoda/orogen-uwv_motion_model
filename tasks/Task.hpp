...
#ifndef UWV_MOTION_MODEL_TASK_TASK_HPP
#define UWV_MOTION_MODEL_TASK_TASK_HPP
...
namespace uwv_motion_model {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','uwv_motion_model::Task')
     end
     \endverbatim
	 ...
	 */
	void eulerToAxisAngle(base::Vector3d &states);
	/**
    ...
    public:
         ...
         */
        Task(std::string const& name = "uwv_motion_model::Task");
